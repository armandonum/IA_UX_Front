<!-- views/roles/estudiante/components/UsabilityConsentModal.vue -->

<template>
  <q-dialog :model-value="show" persistent>
    <q-card>
      <q-card-section>
        <div class="text-overline text-primary">Antes de empezar</div>
        ...
        <div class="text-body2 text-thirth q-mt-md">
          Durante el recorrido se grabará tu pantalla, tu rostro mediante la cámara
          y se analizarán las expresiones faciales para inferir emociones.
          <br /><br />
          Toda la información será utilizada únicamente con fines de investigación.
        </div>
      </q-card-section>
